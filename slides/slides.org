...
#+AUTHOR:    Firstname Familyname \hfill \includegraphics[width=2.5cm]{Wikipedia-logo.png}
#+EMAIL:     emailname@organisat.ion
#+DATE:      Some department\newline Some institute\newline 20xx-0y-zz
...
#+LATEX_HEADER: \setbeamertemplate{frame footer}{frame footer: \color{lightgray}Insert date or something else here}
